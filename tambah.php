<!--Halaman ini untuk menambah user baru dari segi admin dan harus login-->
<?php
...
<body>
    <a href="halaman_awal.php">Go to Home</a>
    <br/><br/>
    ...
    if(isset($_POST['kirim'])) {
        ...
        $result = mysqli_query($mysqli, "INSERT INTO tabel_user
											(nama,email,mobile,alamat,foto) 
										 VALUES
											('$nama','$email','$mobile','$alamat','$foto')");

        echo "Biodata user telah ditambahkan, Terimakasih. <a href='halaman_awal.php'>Lihat Data User</a>";
    }
    ?>
</body>
</html>